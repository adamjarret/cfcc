...
module.exports = ({testSync}) => {
    ...
    fromArgvTest('Load options from file',
        [
            '--config', fixturePath('config-a.json'),
        ],
        {
            token: 'TOKEN_A',
            email: 'EMAIL_A',
    ...
    fromArgvTest('Load options from file and add',
        [
            '--config', fixturePath('config-a.json'),
            ...files
        ],
    ...
    fromArgvTest('Load options from file and override',
        [
            '--config', fixturePath('config-a.json'),
            '--zone', 'NO_FLY'
        ],
    ...
    fromArgvTest('Load options from file that includes another file and override',
        [
            '--config', fixturePath('config-d.json'),
            '--zone', 'NO_FLY'
        ],
        {
            token: 'TOKEN_X',
