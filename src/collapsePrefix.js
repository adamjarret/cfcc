function collapsePrefix(options, pattern = /^cloudflare_/i)
{
    ...
    //  The keys are reverse sorted so if both email and cloudflare_email are present, cloudflare_email wins.
    return Object.keys(options).sort(compareStringDescending).reduce((o, k) => {
